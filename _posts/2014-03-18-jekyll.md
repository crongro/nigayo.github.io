...
전 시험삼아 bootstrap를 사용하진 않았습니다. 매니아분들은 사용하시길 바랍니다. <br/><br/>

그외에 몇가지 더 시험삼아 해본 것들도 있습ㄴ디.
웹사이트의 형태를 좀 갖춰야 함으로,Disqus라는 댓글모듈,페북 like버튼을 달아서 구색을 맞췄고요.

웹사이트의 배포는 배포임으로 grunt로 소스머지 작업 정도만 해봤습니다. 아 약간의 test code도 있군요.(javascript코드가 별로 없어서 구현할 것도 별로 없었습니다 ) <br/><br/>

디자인은 심플함을 가장한 허전함이 컨셉입니다. 해외 모 블로그의 UI 몇곳을 기억해서 상당히 본 딴 것임을 고백합니다.


그리고 아직 이 사이트는 제대로 테스트도 안되고 화면이 군데군데 찌그려저 울상인 상태입니다.<br/><br/> 
